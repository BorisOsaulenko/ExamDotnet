...
namespace hw.Migrations
{
    ...
    [Migration("20251111125533_SimplifiedModels")]
            ...
            modelBuilder.Entity("UserUserPreferences", b =>
                {
                    ...
                    b.Property<int>("FavoriteAuthorsOfId")
                        .HasColumnType("integer");

                    b.HasKey("FavoriteAuthorsId", "FavoriteAuthorsOfId");

                    b.HasIndex("FavoriteAuthorsOfId");
            ...
            modelBuilder.Entity("UserUserPreferences", b =>
                {
                    ...
                    b.HasOne("Models.UserPreferences", null)
                        .WithMany()
                        .HasForeignKey("FavoriteAuthorsOfId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
